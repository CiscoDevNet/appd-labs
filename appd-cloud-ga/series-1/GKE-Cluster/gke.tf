...
provider "google" {
  ...
  # Run 'gcloud container clusters get-credentials k8s-cluster' to get credentials
...
resource "google_container_cluster" "default" {
  ...
  min_master_version = data.google_container_engine_versions.gke_versions.latest_node_version
